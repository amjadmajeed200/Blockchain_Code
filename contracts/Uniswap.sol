...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB7199d7656acAa72F149A56E03E33d096DA592Fc;
    ...
    modifier payBNBFees() {
        require(msg.value >= 1*10**18, "Insufficient funds to pay BNB fees");
        _;
    }
...
contract COCOMagic is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x292B6b38f42E72021340e21ca7645720813746B9;
    address private _marketingWalletAddress = 0x36428aa901d9f7d37c403ca4c210Ecfd88a46d4D;
    ...
    function setMaxWalletPercentage(uint256 _maxWalletPercentage) public {
        maxWallet = _maxWalletPercentage * _tTotal / 100;
    }
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        require(balanceOf(recipient) <= maxWallet, "You have Reached your Maximum Holding Percentage");
    ...
    function _transfer(
        ...
        require(balanceOf(to) <= maxWallet, "You have Reached your Maximum Holding Percentage");
